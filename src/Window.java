...
public class Window extends Application {
    ...
    public void start(Stage stage) {
        ...
        requiemFont = Font.loadFont(
                getClass().getResourceAsStream("font.ttf"), 14
        );
        ...
        VBox rightButtons = createRightButtons(overlay);
        root.setRight(rightButtons);

        HBox progressContainer = createProgressBar();
    ...
    private void setupFilters(VBox topPanel) {
    ...
    private VBox createRightButtons(StackPane overlay) {
        ...
        VBox settingsBox = createSettingsBox(overlay);
        VBox umbrellaBox = createUmbrellaBox(overlay);
    ...
    private VBox createLeftPanel(ScrollPane scrollPane) {
        ...
        setupFilters(topPanel);

        return leftPanel;
    }
    private VBox createSettingsBox(StackPane overlay){
    ...
    private VBox createUmbrellaBox(StackPane overlay){
